...
export default class BlogChapter extends React.Component {
    ...
    measureHeight() {
        ...
        if (this.props.index == 4) {
            ...
            var color_array = next_color_string
                .css("border-bottom")
                .split("solid ");
        ...
        var gradient_style = {
            ...
            top: 8 + "px",
            backgroundImage:
                "linear-gradient(" + this.props.color + ", " + next_color + ")"
    ...
    render() {
        return (
            <div>
                <div
                    id={"blogchapter" + this.props.index}
                    className="blog-chapter"
                >
                    <p id={"blogname" + this.props.index} className="blog-name">
                        {this.props.blog}
                    </p>
                    <div
                        id={"underline" + this.props.index}
                        style={Object.assign(
                            this.state.line_style,
                            this.state.color_style
                        )}
                        className="underline"
                    ></div>
                    ...
                    <div
                        className="gradient"
                        style={this.state.gradient_style}
                    ></div>
                </div>
            </div>
        );
